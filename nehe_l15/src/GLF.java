...
/* One font variables */
    ...
    private static interface DrawSymbol {
        void drawCharacter(GL2 gl, char s);
    }

    private DrawSymbol drawWiredSymbol = new DrawSymbol() {
        public void drawCharacter(GL2 gl, char s) {
    ...
    private int readFont(String font_name, GLFFont glff) {
        ...
        try {
            ...
            for (int i = 0; i < glff.sym_total; i++) {
                ...
                glff.symbols[code].vdata = new float[2 * verts];
...
/* Unload font by font descriptor */
    ...
    public void glfDrawWiredSymbol(GL2 gl, char s) {

        if ((curfont < 0) || (fonts[curfont] == null)) return;
        if (fonts[curfont].symbols[s] == null) return;

        gl.glBegin(GL.GL_LINE_LOOP);
        int tvp = 0; /* temporary vertex pointer */
        int cur_line = 0;
        float x, y;
        for (int i = 0; i < fonts[curfont].symbols[s].vertexs; i++) {
...
/* Draw wired symbol by font_descriptor */
    public void glfDrawWiredSymbolF(GL2 gl, int font_descriptor, char s) {
        int temp;
    ...
    private void DrawString(GL2 gl, String s, DrawSymbol funct) {
        int i;
        float sda, sdb;
        float distance = 0f;
    ...
    public void glfDrawWiredString(GL2 gl, String s) {
        DrawString(gl, s, drawWiredSymbol);
    }

/* Draw wired string by font_descriptor */
    public void glfDrawWiredStringF(GL2 gl, int font_descriptor, String s) {
        int temp;
    ...
    public void glfDrawSolidSymbol(GL2 gl, char s) {
        float x, y;
        ...
        int b = 0; /* Face pointer   */

        gl.glBegin(GL.GL_TRIANGLES);
        for ( int i = 0; i < fonts[curfont].symbols[s].facets; i++) {
            for ( int j = 0; j < 3; j++) {
        ...
        if (contouring == GLF_YES) {
            gl.glGetFloatv(GL2.GL_CURRENT_COLOR, temp_color, 0);
...
/* Draw solid symbol by font_descriptor */
    public void glfDrawSolidSymbolF(GL2 gl, int font_descriptor, char s) {
        int temp;
    ...
    public void glfDrawSolidString(GL2 gl, String s) {
        DrawString(gl, s, drawSolidSymbol);
    }

/* Draw solid string by font_descriptor */
    public void glfDrawSolidStringF(GL2 gl, int font_descriptor, String s) {
        int temp;
...
/* ------------ 3D Wired text drawing ---------------------- */
    ...
    public void glfDraw3DWiredSymbol(GL2 gl, char s) {
        int i, cur_line;
...
/* Draw 3D wired symbol by font_descriptor */
    public void glfDraw3DWiredSymbolF(GL2 gl, int font_descriptor, char s) {
        int temp;
    ...
    public void glfDraw3DWiredString(GL2 gl, String s) {
        DrawString(gl, s, draw3DWiredSymbol);
    }

/* Draw 3D wired string by font_descriptor */
    public void glfDraw3DWiredStringF(GL2 gl, int font_descriptor, String s) {
        int temp;
...
/* ------------ 3D Solid text drawing ---------------------- */
    ...
    public void glfDraw3DSolidSymbol(GL2 gl, char s) {
        int i, j, cur_line;
        boolean flag;
        float x, y;
        float bx = 0f;
        ...
        /* Draw contour, if enabled */
        if (contouring == GLF_YES) {
            gl.glGetBooleanv(GL2.GL_LIGHTING, light_temp, 0);
            gl.glDisable(GL2.GL_LIGHTING);
            gl.glGetFloatv(GL2.GL_CURRENT_COLOR, temp_color, 0);
            gl.glColor4fv(contouring_color, 0);
            glfDraw3DWiredSymbol(gl, s);
            gl.glColor4fv(temp_color, 0);
            if (light_temp[0] != 0) gl.glEnable(GL2.GL_LIGHTING);
        }
    }

/* Draw 3D solid symbol by font_descriptor */
    public void glfDraw3DSolidSymbolF(GL2 gl, int font_descriptor, char s) {
        int temp;
    ...
    public void glfDraw3DSolidString(GL2 gl, String s) {
        DrawString(gl, s, draw3DSolidSymbol);
    }

/* Draw 3D solid string by font_descriptor */
    public void glfDraw3DSolidStringF(GL2 gl, int font_descriptor, String s) {
        int temp;
...
/* ---------------- Console functions ---------------------- */
    ...
    public void glfConsoleDraw(GL2 gl) {
